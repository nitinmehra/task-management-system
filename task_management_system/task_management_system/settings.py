...
SECRET_KEY = 'django-insecure-9nx8ak65fg@d6p568dq9j(c9mf+p*euycsu@!4oh4rx21q_sod'
...
JWT_AUTH = {
    'JWT_EXPIRATION_DELTA': datetime.timedelta(hours=1),  # Set the token expiration time
}
